...
export class UserDetailsService {
  ...
  private getUserDetails_url ="http://13.126.207.114:9088/userprofile/api/v1/user?userEmail=";
  private deleteUserDetails_url = "http://13.126.207.114:9088/userprofile/api/v1/user?userEmail=";
  //Backend saveuser url
  private post_url = "http://13.126.207.114:9088/userprofile/api/v1/user";
