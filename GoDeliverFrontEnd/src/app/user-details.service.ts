...
export class UserDetailsService {
  ...
  private getUserDetails_url ="http://35.154.204.222:9072/userprofile/api/v1/user?userEmail=";
  private deleteUserDetails_url = "http://13.127.190.125:9072/userprofile/api/v1/user?userEmail=";
  //Backend saveuser url
  private post_url = "http://35.154.204.222:9072/userprofile/api/v1/user";
