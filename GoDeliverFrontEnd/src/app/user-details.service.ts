...
export class UserDetailsService {
  ...
  private getUserDetails_url ="http://10.20.1.206:9088/userprofile/api/v1/user?userEmail=";
  private deleteUserDetails_url = "http://10.20.1.206:9088/userprofile/api/v1/user?userEmail=";
  //Backend saveuser url
  private post_url = "http://10.20.1.206:9088/userprofile/api/v1/user";
