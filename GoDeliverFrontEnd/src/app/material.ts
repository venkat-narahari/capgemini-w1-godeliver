...
@NgModule({
  imports: [ MatCheckboxModule, MatMenuModule,
    ...
    MatAutocompleteModule, MatInputModule, MatChipsModule, MatTooltipModule, MatRadioModule ],
  ...
  exports: [ MatCheckboxModule, MatMenuModule, MatIconModule,
    ...
    MatCardModule, MatAutocompleteModule, MatInputModule, MatChipsModule, MatTooltipModule,
    MatRadioModule ]
})
